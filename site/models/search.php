 ...
 * @since  1.6
 */
class BloggerModelSearch extends \Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
    ...
    public function highlightSearch($string) 
    {
        $search = Factory::getApplication()->input->get('search', '');
        return str_replace($search, '<span style="background:yellow;">'.$search.'</span>', $string);
    }
}
