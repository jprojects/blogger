 ...
 * @since  1.6
 */
class BloggerRulesLegacy implements RulesInterface
{
    /**
    ...
    public function build(&$query, &$segments)
    {
        ...
        if (isset($query['id']))
        {
            ...
            if ($view !== null)
            {
				...
				if ($view == 'items')
				{
					$category = Categories::getInstance('blogger.items')->get($query['id']);
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = BloggerHelpersBlogger::getModel($vars['view']);
        ...
        while (!empty($segments))
        {
            ...
            else
            {
				...
				if ($vars['view'] == 'items')
				{
					$category = Categories::getInstance('blogger.items', array('access' => false))->get('root');
					if ($category)
					{
