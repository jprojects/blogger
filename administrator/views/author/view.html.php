 ...
 * @since  1.6
 */
class BloggerViewAuthor extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_BLOGGER_TITLE_AUTHOR'), 'user');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_blogger.author', $this->item->id);
		}
