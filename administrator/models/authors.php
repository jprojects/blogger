 ...
 * @since  1.6
 */
class BloggerModelAuthors extends \Joomla\CMS\MVC\Model\ListModel
{
...
/**
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__blogger_authors` AS a');

		// Join over the user field 'author'
		$query->select('`author`.name AS `author`');
		$query->join('LEFT', '#__users AS `author` ON `author`.id = a.`userid`');
